...
sshpass -p 123456 scp -P 22 ./gluster john@192.168.2.12:/home/john/gluster
...
sshpass -p 123456 scp -P 22 ./src/gluster/gluster_server.json john@192.168.2.12:/home/john/gluster.json
